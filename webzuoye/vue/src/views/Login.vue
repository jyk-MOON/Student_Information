    ...
    <div class="login-card">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" class="login-form">
        <div class="main-content">
          ...
          <div class="third-party-section">
            <div class="section-title">
              <span class="title-text">快捷登录</span>
            ...
            <div class="third-party-buttons">
              ...
              >
                <div class="btn-content">
                  <svg class="third-party-icon qq-icon" viewBox="0 0 1024 1024">
              ...
              >
                <div class="btn-content">
                  <svg class="third-party-icon wechat-icon" viewBox="0 0 1024 1024">
              ...
              >
                <div class="btn-content">
                  <svg class="third-party-icon alipay-icon" viewBox="0 0 1024 1024">
                  ...
                  <span class="btn-text">支付宝登录</span>
                </div>
              </el-button>
            </div>
          </div>
        ...
        <div class="bottom-section">
          ...
          <el-button 
            class="bottom-btn change-password-btn"
...
.title-text {
  ...
  font-weight: 600;
  color: #333;
  background: linear-gradient(90deg, #FF4102FF, #FF6B6B);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  background-clip: text;
  padding-right: 15px;
...
.qq-btn:hover {
  ...
  background: linear-gradient(135deg, rgba(4, 180, 255, 0.1), rgba(255, 255, 255, 0.9)) !important;
}
...
.wechat-btn:hover {
  ...
  background: linear-gradient(135deg, rgba(9, 187, 7, 0.1), rgba(255, 255, 255, 0.9)) !important;
}
...
.alipay-btn:hover {
  ...
  background: linear-gradient(135deg, rgba(22, 119, 255, 0.1), rgba(255, 255, 255, 0.9)) !important;
}
